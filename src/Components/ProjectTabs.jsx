...
export default function ProjectsTabs({
  ...
  return (
    <div className="px-4">
      ...
      {/* Active tab content */}
      <div className="mt-8">
        <div className=" max-w-3xl md:max-w-lg lg:max-w-5xl xl:max-w-6xl items-center mx-auto">
          <div className="flex flex-col md:flex-row justify-between gap-6 md:gap-8">
            ...
            <div className="relative flex flex-col items-center md:items-start">
              ...
              <motion.img
                ...
                src={tabs[active].src}
                alt=""
                className="w-[260px] sm:w-[320px] lg:w-[350px] xl:w-[400px] h-auto object-contain relative z-10"
              />
            </div>
            ...
            >
              <h1 className="text-white font-medium text-xl sm:text-2xl md:text-4xl">
