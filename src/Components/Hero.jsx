  ...
  return (
    <section className="bg-[url('/Images/bg-building.png')] bg-cover bg-center relative min-h-screen w-full overflow-hidden">
      ...
      <div className="hidden md:flex relative w-full h-screen items-center justify-center">
        <div className="absolute left-1/2 top-1/2 -translate-y-1/2 -translate-x-[420px] lg:-translate-x-[480px] xl:-translate-x-[500px] z-30">
          <h1 className="font-poppins font-medium leading-tight">
            <span className="block  md:text-4xl lg:text-5xl xl:text-6xl 2xl:text-7xl text-gray-300">
              Your Trusted Partner in
            </span>
            <span className=" mt-2 md:text-5xl lg:text-6xl xl:text-7xl 2xl:text-8xl bg-gradient-to-r from-[#D8A4A4] to-[#BB3232] bg-clip-text text-transparent">
              Digital Growth.
            </span>
          </h1>
        </div>

        <div className="absolute left-1/2 top-0 bottom-0 translate-x-[50px] lg:translate-x-[80px] xl:translate-x-[100px] flex items-end z-20">
          <div className="relative">
            <img
              src="/Images/Hero.png"
              alt="Hero"
              className="h-[650px] md:h-[700px] lg:h-[750px] xl:h-[800px] 2xl:h-[850px] w-auto object-contain object-bottom"
            />
