  ...
  return (
    <div className=''>
      <div className='flex justify-center'>
        <div className='mt-10 sm:mt-16 md:mt-20 max-w-2xl text-center px-4'>
           <div className="flex items-center justify-center">
            ...
            <span className="mx-4 text-[12px] sm:text-sm md:text-lg  text-main font-bold font-poppins">About us</span>
            <div className="w-16 border-t border-main"></div>
          </div>
        </div>
      </div>  
      ...
      <div className='h-full px-4 sm:px-6'>
        <div className="justify-center max-w-sm md:max-w-md xl:max-w-5xl mx-auto mt-5 sm:mt-7 
                bg-white shadow-top-only rounded-2xl sm:rounded-3xl md:rounded-4xl p-5 sm:p-7 md:p-10 xl:p-14">
          <div className="mb-6 sm:mb-8 md:mb-10 text-left justify-center">
            <p className="font-poppins  text-[10px] sm:text-xs md:text-[15px] leading-relaxed">
        ...
        <div className="flex items-center justify-center bg-white">
          <div className="flex flex-col lg:grid lg:grid-cols-3 gap-6 lg:gap-6 max-w-6xl mx-auto">
            ...
            <div className="relative w-full flex items-center justify-center lg:order-2">
              ...
              />
               ...
               >
                 ...
                 <p className="font-poppins text-[10px] sm:text-xs md:text-sm leading-relaxed">
